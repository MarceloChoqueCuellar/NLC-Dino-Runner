...
from nlc_dino_runner.utils.constants import TITLE, ICON, SCREEN_WIDTH, SCREEN_HEIGHT, BG, FPS, CLOUD, RESET, DARK_MODE, GAME_OVER, SOUND_GAME_LOOP, SOUND_GAME_OVER, LIGHT_MODE
...
class Game:
    ...
    def update(self):
        ...
        self.obstacle_manager.update(self, self.points, self.mode)
    ...
    def draw_background(self):
        ...
        self.screen.blit(CLOUD[self.mode], (self.x_pos_cloud1, self.y_pos_cloud1))
        self.screen.blit(CLOUD[self.mode], (self.x_pos_cloud2, self.y_pos_cloud2))
        self.screen.blit(CLOUD[self.mode], (self.x_pos_cloud3, self.y_pos_cloud3))
        self.screen.blit(CLOUD[self.mode], (self.x_pos_cloud4, self.y_pos_cloud4))
